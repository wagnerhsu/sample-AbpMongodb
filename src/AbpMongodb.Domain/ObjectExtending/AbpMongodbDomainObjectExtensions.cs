...
namespace AbpMongodb.ObjectExtending
{
    public static class AbpMongodbDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the AbpMongodbEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
